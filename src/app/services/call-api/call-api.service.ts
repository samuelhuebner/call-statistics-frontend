...
export class CallApiService {
    ...
    public getCurrentCalls(): Promise<Call[]> {
        ...
        return this.httpClient.get<Call[]>(apiURL).toPromise();
    }
    ...
    public endCall(callId: string): Promise<any> {
        ...
        return this.httpClient.post(apiURL, { callId }).toPromise();
    }
    ...
    public resetHotline(hotlineId: number): Promise<any> {
        ...
        return this.httpClient.post(apiURL, { hotlineId }).toPromise();
    }
    ...
    public getUsers(): Promise<User[]> {
        ...
        return this.httpClient.get<User[]>(apiURL).toPromise();
    }
}
